/* Task 4 (C, transform-only): sum(price * quantity) scalar, repeated N=216,000 times. */
...
#define OUT_PATH "design_analysis/benchmarks/transform/out/c/task_4.csv"
