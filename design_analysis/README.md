...
- **Arche is within ~1–1.3× of hand-written `-O3` C** - both AVX2-vectorize the SoA column ops.
  Task 1 lands at parity (a sub-1.0× reading is LLVM codegen noise, not a real win - both
  backends are LLVM).
