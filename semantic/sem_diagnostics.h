...
typedef enum {
	...
	SEM_DIAG_schedule_entry_not_runnable,
	SEM_DIAG_tick_no_schedule,
	SEM_DIAG_tick_in_map,
	SEM_DIAG_tick_in_system,
	SEM_DIAG_tick_not_statement,
	SEM_DIAG_tick_reserved_name,
